...
export default function Footer() {
  return (
    <footer className="w-full">
      ...
      <hr className="my-4" />
      <div className="mx-auto max-w-6xl items-center justify-between px-4 py-6 md:flex lg:px-0">
        <div className="inline-flex items-center">
          
          <img src="logo.png" alt="" width="35px" />
          <span className="ml-4 text-lg font-bold">MediScan</span>
        </div>
        <div className="mt-4 md:mt-0">
          <p className="text-sm font-medium text-gray-500">© 2023 MediScan. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
